...
<body>
    ...
    <main>
        ...
        <form action="">
            <a href="{{ route('seeAddCategoryForm') }}">Ajouter une catégorie</a>
            @if ((isset($categories) AND !empty($categories)))
                <input type="text" id="searchInput" placeholder="Rechercher..." onkeydown="return (event.keyCode!=13);" data-element="category">
            @endif
        </form>
        <div id="boardAndBlocPagination">
            @include('layout.adminCategoryBoardAndBlocPagination')
        </div>
    </main>
